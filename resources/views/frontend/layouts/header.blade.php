                            ...
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    <a class="mini-cart-icon" href="{{ route('frontend.view-cart') }}">
                                        ...
                                        <span class="pro-count blue" id="count">{{ $totalItems }}</span>
                                    </a>
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    <span class="lable ml-0 text-primary mt-3" style="cursor: pointer">@ {{ Auth::user()->name }}</span>
                    ...
                    <div class="header-nav d-none d-lg-flex">
                        ...
                        @if ($showCategoryButton == true)
                            ...
                            <div class="main-categori-wrap d-none d-lg-block">
                                ...
                                <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading" id="showMoreButton">

                                    <div class="d-flex categori-dropdown-inner d-flex flex-row" id="categoryList">
